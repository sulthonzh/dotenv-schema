...
class Generator {
     ...
     */
    static generateEnvExample(schema) {
        const lines = [];
    ...
    static getTypeScriptType(field) {
        switch (field.type) {
            case 'string':
                return 'string';
            case 'number':
    ...
    static getValueCheck(access, field) {
        switch (field.type) {
            case 'string':
     ...
     */
    static generateValidator(schema) {
        const lines = [];
