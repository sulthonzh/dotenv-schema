...
(0, node_test_1.describe)('EnvParser', () => {
    ...
    (0, node_test_1.describe)('inferType', () => {
        (0, node_test_1.it)('should infer boolean type', () => {
            ...
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('TRUE'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('FALSE'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('1'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('0'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('yes'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('no'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('on'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('off'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('YES'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('NO'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('ON'), 'boolean');
            node_assert_1.default.strictEqual(parser_1.EnvParser.inferType('OFF'), 'boolean');
    ...
    (0, node_test_1.describe)('inferSchema', () => {
        (0, node_test_1.it)('should create schema from .env file', () => {
            ...
            node_assert_1.default.strictEqual(schema.MY_VAR.type, 'string');
            node_assert_1.default.strictEqual(schema.MY_VAR.required, true);
            node_assert_1.default.strictEqual(schema.MY_VAR.default, 'production');
